{{--
    Developer account-created email — same table-layout/inline-style reasoning as
    mail/broker-approved.blade.php (Outlook and most mobile clients strip <style>
    blocks and don't implement flex/grid).
--}}
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>{{ $appName }} — developer account created</title>
</head>
<body style="margin:0; padding:0; background-color:#f5f5f7;">

    <div style="display:none; max-height:0; overflow:hidden; opacity:0;">
        Your developer account is ready — here is how to sign in.
    </div>
                    ...
                    <tr>
                        <td style="padding:30px 28px 8px;">
                            ...
                            <p style="margin:0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;
                                ...
                                An account @if($company)for <strong style="color:#1d1d1f;">{{ $company }}</strong> @endif
                                has been created on {{ $appName }}. You can sign in now to list your
                                projects and review requests from our channel partner network.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:24px 28px 4px;">
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                                @foreach([
                                    'List and manage your projects and unit inventory',
                                    'Review requests from channel partners and accept the ones you want',
                                    'Track leads from first request through to close',
                                    'Update your company profile, logo and commercial terms',
                                ] as $item)
                                    <tr>
                    ...
                    <tr>
                        <td style="padding:8px 28px 30px;">
                            <p style="margin:0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;
                                ...
                                Open the {{ $appName }} app or panel and sign in with the details above.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="border-top:1px solid #e8e8ed; padding:18px 28px;">
                            <p style="margin:0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;
                                ...
                                If you did not expect this account, reply to this email and we'll close it.
                            </p>
                        </td>
                    </tr>
                </table>
