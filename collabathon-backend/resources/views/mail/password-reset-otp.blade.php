{{--
    Password reset code email — same table-layout, inline-style reasoning as
    mail.email-otp: Outlook and most mobile clients strip <style> blocks and don't do
    flex/grid.
--}}
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>{{ $appName }} — your password reset code</title>
</head>
<body style="margin:0; padding:0; background-color:#f5f5f7;">

    <div style="display:none; max-height:0; overflow:hidden; opacity:0;">
        Your {{ $appName }} password reset code is {{ $code }}. It expires in {{ $minutes }} minutes.
    </div>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr>
                        <td style="padding:28px 28px 0;">
                            <p style="margin:0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;
                                      font-size:13.5px; line-height:1.6; color:#3a3a3c;">
                    ...
                    <tr>
                        <td style="padding:24px 28px 8px; text-align:center;">
                            ...
                            <p style="margin:14px 0 0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;
                                ...
                                Expires in {{ $minutes }} minutes. Enter it on the reset screen to continue.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="border-top:1px solid #e8e8ed; padding:18px 28px;">
                            <p style="margin:0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;
                                ...
                                changed, and nobody can change it without also having access to this inbox.
                            </p>
                        </td>
                    </tr>
                </table>
