    ...
    @foreach($rows as $i => $r)
        ...
        <div x-data="{ hot: false }" @mouseenter="hot = true" @mouseleave="hot = false" class="group flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
                ...
                {{-- Bar: <=24px thick, rounded pill ends. --}}
                <div class="relative h-4 bg-canvas rounded-full overflow-hidden">
                    <div class="h-full rounded-full transition-[filter,width] duration-150"
