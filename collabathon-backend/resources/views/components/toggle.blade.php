...
<button type="button"
        ...
        {{ $attributes->merge(['class' => 'inline-flex items-center shrink-0 w-[38px] h-[21px] px-[2px] cursor-pointer transition-colors duration-150']) }}>
    <span :class="on ? 'translate-x-[17px]' : 'translate-x-0'"
          class="block w-[17px] h-[17px] bg-white shadow-sm transition-transform duration-150"></span>
</button>
