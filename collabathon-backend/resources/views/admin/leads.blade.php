...
<x-layouts.admin active="leads" title="Approvals" section="Manage">
    ...
    {{-- Each card filters the developer roster below to those with at least one lead in
         that bucket — a developer can sit in every bucket at once, so this narrows the
         list rather than "selecting" a single-valued status the way a lead row has. --}}
